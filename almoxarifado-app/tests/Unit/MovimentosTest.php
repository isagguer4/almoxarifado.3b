...
// 1. Teste de validção que simula o @beforeCreate
test('sistema deve barrar a movimentação de saída se a quantidade retirada for maior que o estoqu', function(){
...
test('O sistema deve diminuir o estoque após uma saída autorizada', function(){
    ...
    (Movimento::count())->toBe(1);

//2.1 O seu hock afterCreate deve ter diminuído o estoque de 15 para 10
